...
const Ammonia = () => {
  ...
  const generateRandomHistoryData = () => {
    return Array.from({ length: 30 }, (_, index) => ({
      ...
      ammonia: Math.floor(Math.random() * (30 - 15 + 1)) + 15,
    }));
  };
  ...
  const data = {
    ...
    datasets: [
      {
        data: Array.from({ length: 5 }, () => Math.floor(Math.random() * (30 - 15 + 1)) + 15),
      },
    ],
  };
  ...
  const renderHistoryItem = ({ item }) => (
    <View style={styles.historyRow}>
      ...
      <Text style={styles.historyCell}>{item.ammonia.toFixed(1)} ppm</Text>
    </View>
  );
        ...
        <>
          ...
          <View style={styles.historyTable}>
            <View style={styles.historyHeader}>
              ...
              <Text style={styles.historyHeaderCell}>Ammonia (ppm)</Text>
            </View>
            <FlatList
  ...
  const showFilterOptions = () => {
    ...
    Alert.alert(
      'Select a Tank',
      'Choose a tank to view its ammonia history.',
